 ...
 * @author cristobal
 */
@WebServlet(name = "AdministradorEditarProductoServlet", urlPatterns = {"/AdministradorEditarProductoServlet"})
public class AdministradorEditarProductoServlet extends SampleTAWServlet {
