 ...
 * @author power
 */
@WebServlet(name = "MarketingAnadirUserServlet", urlPatterns = {"/MarketingAnadirUserServlet"})
public class MarketingAnadirUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //Añadimos el usuario a la listaDeUsuarios
        this.uls.crearUsuarioLista(usuario,lista);
