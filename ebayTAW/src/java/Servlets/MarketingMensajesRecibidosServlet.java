 ...
 * @author power
 */
@WebServlet(name = "MarketingMensajesRecibidosServlet", urlPatterns = {"/MarketingMensajesRecibidosServlet"})
public class MarketingMensajesRecibidosServlet extends HttpServlet {
