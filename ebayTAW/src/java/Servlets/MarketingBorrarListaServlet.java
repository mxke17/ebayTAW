 ...
 * @author power
 */
@WebServlet(name = "MarketingBorrarListaServlet", urlPatterns = {"/MarketingBorrarListaServlet"})
public class MarketingBorrarListaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Integer listID = Integer.parseInt(request.getParameter("idList"));
        
        //Borramos la lista seleccionada
        // 2.- Borrar Usuariolista where listID = idList
            this.uls.borrarUsuarioLista(listID);
        // 1.- Borrar ListaUsuario where listID = idList
            this.lu.borrarLista(listID);
